...
import karunaTrust from '../Image/karunaTrust.jpg';
...
class MUIDataTable extends React.Component {
 ...
 <p style={{textAlign:'center'}}><img src={karunaTrust}  alt="Image"/>
    <h6 style={{textAlign:'center'}}>Karuna Community Eye Care Center</h6> <p style={{textAlign:'center'}}>110/1/1, Dehiwala Road, Maharagama, Sri Lanka.  Phone: +94 77 2914060</p>
 
            <hr style={{borderTop:"3px solid black"}}/></p> 
            <p style={{fontSize:"18px",textAlign:'center'}}><u>List of Registered Patients </u></p> 
            <p style={{ fontSize:"18px",textAlign:"right",margin:"1em",}}>Total of Patients - <b>{this.props.patientsCount}</b></p>
           {this.props.fromDate && this.props.toDate && <p style={{fontSize:"18px",textAlign:'center'}}>-Patients Registered from {this.props.fromDate} to {this.props.toDate} -</p>}
