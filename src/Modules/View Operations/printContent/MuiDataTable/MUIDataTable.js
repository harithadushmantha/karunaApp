    ...
    return (<div>
      ...
      <Paper
        ...
        <div style={{ position: 'relative' }} className={responsiveClass}>
          ...
          <p style={{ fontSize: "18px", textAlign: 'center' }}><u>List of Patients Operations </u></p>
          <p style={{ fontSize: "18px", textAlign: "right", margin: "1em", }}>Total of Operations - <b>{this.props.patientsCount}</b></p>
          {this.props.fromDate && this.props.toDate && <p style={{ fontSize: "18px", textAlign: 'center' }}>-Operations done from {this.props.fromDate} to {this.props.toDate} -</p>}
